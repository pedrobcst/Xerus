...
# $Date: 2021-01-08 09:06:12 +0900 (金, 08  1月 2021) $
# $Author: toby $
# $Revision: 4741 $
# $URL: https://subversion.xray.aps.anl.gov/pyGSAS/trunk/GSASIIpath.py $
# $Id: GSASIIpath.py 4741 2021-01-08 00:06:12Z toby $
########### SVN repository information ###################
'''
...
def SetVersionNumber(RevString):
    ...
    :param str RevString: something like "$Revision: 4741 $"
      that is set by subversion when the file is retrieved from subversion.

    Place ``GSASIIpath.SetVersionNumber("$Revision: 4741 $")`` in every python
    file.
    '''
    try:
